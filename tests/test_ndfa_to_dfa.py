...
from autome.finite_automata import JFlapConverter, DeterministicFiniteAutomata, JSONConverter
...
def test_ndfa_to_dfa():
    ...
    """
    machine = JFlapConverter.parse(source=Path("./machines/cross-machine.jff"), deterministic=False)
