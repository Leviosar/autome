from autome.finite_automata.machine import (
...
class PositiveClosureAutomata(NonDeterministicFiniteAutomata):
    ...
    def __init__(self, a: NonDeterministicFiniteAutomata) -> "PositiveClosureAutomata":
